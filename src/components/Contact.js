                  ...
                  <form onSubmit={handleSubmit}>
                    <Row>
                      <Col size={12} sm={12} className="px-1">
                        <input required type="text" value={formDetails.fullName} placeholder="Full Name (required)" onChange={(e) => onFormUpdate('fullName', e.target.value)} />
                      </Col>
                      <Col size={12} sm={12} className="px-1">
                        <input required type="email" value={formDetails.email} placeholder="Email Address (required)" onChange={(e) => onFormUpdate('email', e.target.value)} />
                      </Col>
                      <Col size={12} sm={12} className="px-1">
